      ...
      <section className="bg-[#174D2C] py-16 text-white lg:py-20">
        <div className="mx-auto flex max-w-6xl flex-col gap-7 px-6 lg:flex-row lg:items-center lg:justify-between lg:px-8">
          <div>
            ...
            <h2 className="mt-3 max-w-2xl font-serif text-3xl font-semibold leading-tight sm:text-4xl">Menjadi Bagian dari BMT Al-Muhajirin</h2>
            <p className="mt-4 max-w-2xl text-[15px] leading-7 text-[#DCEAD4]">Bergabung sebagai anggota dan tumbuh bersama koperasi yang telah melayani masyarakat sejak 1998. Nikmati layanan simpanan, pembiayaan, dan berbagai layanan anggota dengan prinsip kebersamaan dan syariah.</p>
          </div>
